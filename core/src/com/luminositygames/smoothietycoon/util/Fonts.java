...
public class Fonts {
	...
	public static final int BLACK_36 = 1;
	public static final int WHITE_36 = 2;
	
	public static final int BLACK_48 = 3;
	public static final int WHITE_48 = 4;
	...
	public static void load(int ID, Color color, int size){		
		...
		parameter.size = size;
		font = font_gen.generateFont(parameter);
