...
public class Yogurt extends Window {

	public Yogurt(int y, int width, int height) {
	...
	public void render(Game game) {
		...
		for (int i = 0; i < 3; i++){
			...
			Fonts.left(Shop.YOGURT.getString(i), 460, i * 85 + 200, Color.BLACK, 36);
		}
	}
	...
	public void handle(Game game) {
		for (int i = 0; i < 3; i++){
			if (Fonts.isTouched(Shop.YOGURT.getString(i), 465, i * 85 + 200, Color.BLACK, 36)){
