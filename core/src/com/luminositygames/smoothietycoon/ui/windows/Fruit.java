...
public class Fruit extends Window {

	public Fruit(int y, int width, int height) {
	...
	public void render(Game game) {
		...
		for (int i = 0; i < 3; i++){
			...
			Fonts.left(Shop.FRUIT.getString(i), 460, i * 85 + 200, Color.BLACK, 36);
		}
	}
	...
	public void handle(Game game) {
		for (int i = 0; i < 3; i++){
			if (Fonts.isTouched(Shop.FRUIT.getString(i), 465, i * 85 + 200, Color.BLACK, 36)){
